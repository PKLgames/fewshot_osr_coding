...
class NDS(Dataset):
    ...
    def __init__(self, root='./', phase='train', 
        ...
        self.all_train_df = pd.read_csv(f"/yourdatapath/nsynth-100-fs_train.csv")
        self.all_val_df = pd.read_csv(f"/yourdatapath/nsynth-100-fs_val.csv")
        self.all_test_df = pd.read_csv(f"/yourdatapath/nsynth-100-fs_test.csv")
        with open(f"/yourdatapath/nsynth-100-fs_vocab.json") as vocab_json_file:
