...
TARGET_DIR="../DCASE2018-task5-dev/audio"  # 统一存放wav文件的目标文件夹
EXTRACT_DIR="../temp_extract"  # 临时解压目录

echo "开始处理DCASE2018-task5-dev压缩文件..."

unzip -q -o ./DCASE2018-task5-dev.doc.zip -d ../
unzip -q -o ./DCASE2018-task5-dev.meta.zip -d ../
...
for zipfile in $(ls DCASE2018-task5-dev.audio.*.zip | sort -V); do
    echo "正在处理: $zipfile"
