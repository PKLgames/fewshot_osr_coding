...
def main():
    ...
    # TAU-19: 10 acoustic scene classes -> 6 base (known), 4 novel (unknown)
    # 0=airport, 1=shopping_mall, 2=metro_station, 3=street_pedestrian,
    # 4=public_square, 5=street_traffic
    # 6=tram, 7=bus, 8=metro, 9=park
